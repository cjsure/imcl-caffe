...
file_path = 'D:\Project\caffe-windows-master-zhangjunhui\data\gray\\test.proto'
dir_path = 'D:\Project\caffe-windows-master-zhangjunhui\data\gray\\'
dst_path = "D:\Project\caffe-windows-master-zhangjunhui\data\gray\\test\\"
phase = 'test'
...
def copy_files(file_path):
    ...
    if not os.path.isdir(dst_path+"gray/"):
        os.mkdir(dst_path+"gray/")
    for file in file_list:
        tmp_file = dir_path + file
        if not os.path.exists(tmp_file):
            print "not exist:"+tmp_file
            continue
